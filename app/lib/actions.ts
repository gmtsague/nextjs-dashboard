...
export async function createInvoiceWithState(prevState: State, formData: FormData) {
  ...
  const date = new Date().toISOString().split('T')[0];
      ...
      console.log('type of datas to send to database: ', typeof validatedFields.data.amount);
...
export async function createInvoice(formData: FormData) {
  ...
  const date = new Date().toISOString().split('T')[0];
      ...
      console.log('type of datas to send to database: ', typeof rawFormData.amount);
